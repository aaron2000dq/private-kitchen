  ...
  return (
    <button
      className={cn(
        ...
        variant === "primary" &&
          "bg-[color:var(--foreground)] text-[color:var(--background)] shadow-[var(--shadow-soft)] hover:bg-black/90 dark:hover:bg-white/90",
        variant === "outline" &&
        ...
        variant === "danger" &&
          "bg-[color:var(--warm)] text-white hover:brightness-[0.98]",
        className,
      )}
      {...props}
    />
